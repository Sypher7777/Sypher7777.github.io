(function(opspark, createjs, draw, _) {
    ...
    function(game) {
      ...
      const
        ...
        textfield = draw.textfield('Settings', 'bold 60px Arial', '#EEE');
      ...
      function onAdded(event) {
        if(game.getDebug()) console.log('settings view added to stage');
